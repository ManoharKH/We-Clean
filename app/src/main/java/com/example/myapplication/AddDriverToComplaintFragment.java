...
public class AddDriverToComplaintFragment extends Fragment implements ComplaintAdminAdapter.ComplaintAdminClickInterface {
    ...
    public AddDriverToComplaintFragment() {
        // Required empty public constructor
    }

    public static AddDriverToComplaintFragment newInstance(String param1, String param2) {
        AddDriverToComplaintFragment fragment = new AddDriverToComplaintFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_add_driver_to_complaint, container, false);
    ...
    private void getAdminComplaint() {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if(admin_status.equals("Complaint Verified")) {
    ...
    private void displayBottomSheet(Complaint complaint){
        ...
        btnupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(status.equals("Complaint Verified")){
                    Intent it = new Intent(getContext(),AddDriverToComplaintActivity.class);
